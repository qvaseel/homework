...
<body class="mx-auto">
    <header class="bg-slate-300 p-5">
        <nav class="max-w-5xl mx-auto flex items-center gap-5">
            <a class="text-2xl active:font-semibold hover:font-semibold" href="{{ route('home') }}">Главная</a>
            <a class="text-2xl active:font-semibold hover:font-semibold" href="{{ route('array') }}">Массив</a>
